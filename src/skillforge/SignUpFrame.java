...
public class SignUpFrame extends javax.swing.JFrame {
   ...
   private boolean idExists(int id) {
    for (Record r : Main.studentManager.read()) {
        Student s = (Student) r;
        if (s.getUserId() == id) return true;
    }
    for (Record r : Main.instructorManager.read()) {
    ...
    boolean ok = Main.userManager.signup(role, id, username, email, password);
    ...
    JsonDatabase.saveUsers(Main.studentManager, Main.instructorManager);
